...
public class PlayActivity extends Activity {
	...
	private TextView questionTextView,answertextView,showTextView;
	private ImageView passView,failView;
	private Button answer[]=new Button[3];
	private Button show[]=new Button[1];
  ...
  //      mediaPlayer.start();
        ...
        questionTextView=(TextView)findViewById(R.id.textView1);//显示公式
        ...
        showTextView=(TextView)findViewById(R.id.textView3);//显示答案是否正确
        ...
        answer[2]=(Button)findViewById(R.id.button3);
     	show[0]=(Button)findViewById(R.id.button5);
